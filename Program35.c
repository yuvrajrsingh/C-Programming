/* This program demonstrates the math functions from the C math.h library, so that you can get your homework right thanks to some quick 
...
main(){
    ...
    printf("The arc tangent of 15-degree angle is %.3f\n", atan((15*(3.14159/180.0))));
