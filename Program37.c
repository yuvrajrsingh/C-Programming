/* This program creates an array of 10 game scores for a basketball player. The scores from the first six games are in the program and 
the scores from the last four are inputted by the user. */
