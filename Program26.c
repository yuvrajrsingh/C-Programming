/* This program will ask users how many movies they've seen this year, and then loop through asking the name of each movie and a rating 
from 1 to 10. It will remember their favorite movie and their least favorite movie. */
...
main(){
    ...
    // initialize the favRating to 0 so any movie with any rating of 1 or higher will replace it and the leastRating to 10 so any movie 
    // rated 9 or lower will replace it
