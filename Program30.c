/* This program presents a menu of choices (three different decades), gets the user's choice, and then presents a secondary menu 
(sports, entertainment, and politics). When the user makes her second choice, it prints a list of key information from that specific 
decade in that specific category.*/
...
main(){
    ...
    // The top-menu choice and the switch statement that makes the resulting information appear are encased in a do-while loop that
    // ensures one of the 4 menu choices are made
    do {
