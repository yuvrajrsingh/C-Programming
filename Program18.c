...
main(){
    ...
    // The if statement can do some data validation, making sure the year makes sense
    // The statement will only execute if the year is after the current year

    if (yearBorn > CURRENTYEAR){
        
        printf("Really? You haven't been born yet?\nCongratulations on time travel!\n");
    } else {
